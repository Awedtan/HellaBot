...
import { ccDict, enemyDict, initializeData, operatorDict, paradoxDict, rogueThemeArr, stageDict, toughStageDict } from './data';
...
export default class HellaBot {
    ...
    async loadCommands() {
        ...
        for (const file of commandFiles) {
            ...
            commandArr.push(command.default.data.toJSON());
        }
